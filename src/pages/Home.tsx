    ...
    <div className="min-h-screen text-black relative overflow-hidden bg-white flex flex-col">
      ...
      <div className="relative z-20 flex-1 flex flex-col">
        ...
        <main className="flex-1 flex flex-col">
          <div className="container mx-auto px-4 md:px-8 pt-32 xs:pt-36 sm:pt-40 pb-12 md:pb-20 flex-1 mx-5">
            {/* Hero Section */}
            <div className="min-h-[90vh] flex flex-col justify-center relative">
              <div className="relative">
                <div className="text-left text-5xl xs:text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold tracking-tight leading-[0.9] max-w-full md:max-w-[80%] md:ml-[170px] lg:ml-[210px] -mt-[45px]">
                  digitale<br />Magie.
                </div>
                <div className="relative md:absolute mt-8 md:mt-0 md:top-[calc(100%-2rem)] text-left max-w-full md:max-w-[600px] md:left-[calc(50%+180px)] md:-translate-x-1/2 mb-12">
                  <h1 className="text-sm xs:text-base sm:text-lg md:text-xl font-bold leading-tight">
                    mizmu – Deine Agentur<br />
                    für starke Marken.<br />
                    Webdesign, Branding,<br />
                    Online & Social Media Marketing –<br />
                    alles für deinen digitalen Auftritt.
                  </h1>
                </div>
              </div>
            </div>
            ...
            <div className="min-h-[40vh] md:min-h-[80vh] flex items-center justify-center py-2">
              <div className="text-center">
                <div className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight leading-tight content-spacing mb-6 md:mb-8">
